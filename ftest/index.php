...
<html>
    ...
    <body>
        ...
        $shortMonthStr = array("mon", "tue", "wed", "thu", "fri", "sat", "sun");
        $monthStr = array("monday", "tuesday", "wedensday", "thursday", "friday", "saturday", "sunday");
        ...
        for ($dd = 1; $dd < 8; $dd++) {
            $ypos = 50;
            $xpos = 26 + $dd * 33;
            e('l', '',$xpos, $ypos, 32, 32, 10, 1, 'solid black', $shortMonthStr[$dd - 1], 'c', '', '');

            $ypos = 5;
            $xpos = 388 + ($dd - 1) * ($hw + 1) * 3;
            e('l', '',$xpos, $ypos, $hw * 3, 32, 24, 0, '', $monthStr[$dd - 1], 'c', '', '');
        }
